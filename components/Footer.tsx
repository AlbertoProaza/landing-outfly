        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              {/* Redes sociales */}
              <a 
                href="https://www.linkedin.com/company/outfly-marketing" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/outfly.marketing" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#FF0088] transition-colors duration-300"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-gray-400">
                ...
                <a href="mailto:albertoproaza04@gmail.com" className="hover:text-[#00D4FF] transition-colors duration-300">
                  albertoproaza04@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2 text-gray-400">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
